...
export KUBECONFIG=${PWD}/dev-feature/kube-config/config
...
kubectl  apply -n $KUBE_NAMESPACE --force -f dev-feature/volume.yaml
...
kubectl  exec tools ./bin/init-data-dev-feature.sh
